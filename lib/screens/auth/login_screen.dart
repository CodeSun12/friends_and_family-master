...
import 'package:friends_and_family/practice/my_home_screen.dart';
...
import '../../practice/product_screen.dart';
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  login(String username, password)async{
    try{
      ...
      if(response.statusCode == 200){
        ...
        //       subsidyPercentage: data["subsidy_percentage"],
        //       startingDate: data["starting_date"],
        //       subsidyDate: data["subsidy_date"],
        //       token: data["token"],
        //     )
        //     )
        // );
  ...
  Widget build(BuildContext context) {
    // final myProvider = Provider.of<CustomerProvider>(context);
